...
Stage 7  Prototype Build Spec ──── translate prototype spec into a first-build implementation handoff
```
...
| `prompt.md` | Full agent contract including role, input/output, reasoning rules, and forbidden behaviors. |
